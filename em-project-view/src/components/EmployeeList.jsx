        ...
        {employees.map((employee) => (
          <tr key={employee.id} className="hover:bg-white hover:text-black">
            ...
            <td className="text-left px-6 py-4 whitespace-nowrap">
              <a onClick={(e) => editEmployee(e, employee.id)} className="hover:text-green-500 hover:cursor-pointer">
                Edit 📝
              </a>
              <a onClick={(e) => deleteEmployee(e, employee.id)} className="hover:text-red-500 hover:cursor-pointer">
                Delete 🗑️
              </a>
            </td>
          </tr>
